    ...
    def __sub__(self, other):
        try:
            if self.number - other.number > 0:
                ...
                return 'Первоначальная клетка слишком мала, вычитание невозможно'
        except Exception as e:
            print(e)
    ...
    def __floordiv__(self, other):
        try:
            if self.number // other.number > 0:
                ...
                return 'Первоначальная клетка слишком мала, целочисленное деление невозможно'
        except Exception as e:
            print(e)
    ...
    def __truediv__(self, other):
        try:
            if self.number // other.number > 0:
                ...
                return 'Первоначальная клетка слишком мала, деление невозможно'
        except Exception as e:
            print(e)
